...
suwind < SEG_C3WA_ffid_1-1200_proc.su key=cdp min=169202 max=191701 > tmp1.su
suwind < SEG_C3WA_ffid_1201-2395_proc.su key=cdp min=169202 max=191701 > tmp2.su
...
suwind < SEG_C3WA_ffid_1-1200_proc.su key=cdp min=$mincdp max=$maxcdp > tmp$inline.su
...
suwind < SEG_C3WA_ffid_1201-2395_proc.su key=cdp min=$mincdp max=$maxcdp > tmp$inline.su
...
cat tmp*.su > tmp
susort <tmp cdp offset > SEG_C3WA_ffid_proc_red.su
