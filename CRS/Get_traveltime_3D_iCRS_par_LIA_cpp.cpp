...
void iCRSstack(int nt, double *attr, double *mx, double *my, double *hx, double *hy, double *mxmx, double *mxmy, double *mymy, double *hxhx, double *hxhy, double *hyhy, double *tti)
{
    ...
    double Mxx, Mxy, Myy; 
    double Nxx, Nxy, Nyy;
    double MNxx, MNxy, MNyy, detMN;
    double MMNxx, MMNxy, MMNyx, MMNyy; 
    ...
    MNxy = Mxy - Nxy; 
    MNyy = Myy - Nyy;
    detMN = MNxx*MNyy - MNxy*MNxy; 
    MNxx = MNxx/detMN; 
    MNxy = MNxy/detMN; 
    MNyy = MNyy/detMN; 
    
    MMNxx = Mxx*MNyy - Mxy*MNxy;  
    MMNxy = Mxy*MNxx - Mxx*MNxy; 
    MMNyx = Mxy*MNyy - Myy*MNxy; 
    MMNyy = Myy*MNxx - Mxy*MNxy; 
    
    Kxx = MMNxx*Nxx + MMNxy*Nxy; 
    Kxy = MMNxx*Nxy + MMNxy*Nyy; 
    Kyy = MMNyy*Nyy + MMNyx*Nxy; 
    ...
    {   
        ...
        zeta = t0 + Kxx*dxr*dxr + 2*Kxy*dxr*dyr + Kyy*dyr*dyr; 
        ...
        for(iter=0;iter<3;iter++){
            ...
            Axx = kappa*Kxx + attr[2]; 
            Axy = kappa*Kxy + attr[3];
            Ayy = kappa*Kyy + attr[4];
